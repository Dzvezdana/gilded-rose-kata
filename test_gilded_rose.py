...
class GildedRoseUpdaterTest(unittest.TestCase):
    ...
    def test_normal_item_on_sell_date(self):
        items = [item_factory.create(name="foo", sell_in=0, quality=9)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
    ...
    def test_normal_with_zero_quality(self):
        items = [item_factory.create(name="foo", sell_in=2, quality=0)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(1, items[0].sell_in)
    ...
    def test_brie_before_sell_date(self):
        items = [item_factory.create(name="Aged Brie", sell_in=2, quality=0)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(1, items[0].sell_in)
    ...
    def test_brie_over_max_quality(self):
        items = [item_factory.create(name="Aged Brie", sell_in=2, quality=52)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(1, items[0].sell_in)
        self.assertEqual(50, items[0].quality)
    ...
    def test_brie_negative_quality(self):
        items = [item_factory.create(name="Aged Brie", sell_in=2, quality=-5)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(1, items[0].sell_in)
        self.assertEqual(0, items[0].quality)
    ...
    def test_sulfuras_max_quality(self):
        items = [item_factory.create(name="Sulfuras, Hand of Ragnaros", sell_in=1, quality=82)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(80, items[0].quality)
    ...
    def test_backstage_sell_in_15(self):
        items = [item_factory.create(name="BackStage Passes to a TAFKAL80ETC concert", sell_in=15, quality=20)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(21, items[0].quality)

    def test_backstage_sell_in_10(self):
        items = [item_factory.create(name="BackStage Passes to a TAFKAL80ETC concert", sell_in=10, quality=20)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
    ...
    def test_backstage_quality_change_50(self):
        items = [item_factory.create(name="BackStage Passes to a TAFKAL80ETC concert", sell_in=10, quality=50)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)
    ...
    def test_conjured_before_sell_date(self):
        items = [item_factory.create(name="Conjured Mana Cake", sell_in=3, quality=6)]
        gilded_rose = GildedRoseUpdater(items)
        gilded_rose.update_quality()
    ...
    def test_other_products(self):
        dexterity_item = [item_factory.create(name="+5 Dexterity Vest", sell_in=10, quality=20)]
        elixir_item = [item_factory.create(name="Elixir of the Mongoose", sell_in=5, quality=7)]
